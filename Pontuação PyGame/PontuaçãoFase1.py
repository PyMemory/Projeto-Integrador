...
def calcular_tentativas_por_fase1():
    
    tentativas = cartas_viradas_por_fase1() // 2
    
    return  tentativas

#função que calcula os pontos por fase

def calcular_pontos_fase1():
        
    tentativa = calcular_tentativas_por_fase1()
    pontuacao1 = int
